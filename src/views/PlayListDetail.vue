<template>
  <div class="playlist-container">
    <div class="top-wrap">
      <div class="img-wrap">
        <!-- 封面 -->
        <img :src="playlist.coverImgUrl" alt="封面" />
      </div>
      <div class="info-wrap">
        <!-- 名字 -->
        ...
        <div class="author-wrap">
          ...
          <!-- 时间 -->
          <span class="time">{{ playlist.createTime | YearFormat }}</span>
        </div>
        <div class="play-wrap">
          ...
          <div class="comments-wrap">
            ...
            <div class="item" v-for="(item, index) in hotComments" :key="index">
              ...
              <div class="content-wrap">
                ...
                <div class="date">{{ item.time | YearFormat }}</div>
              </div>
            </div>
          </div>
        </div>
...
<script>
import { getPlayDetail, getPlayComment } from "@/network/playlists.js";
...
export default {
  ...
  methods: {
    ...
    // 保存热门评论
    _getPlayComment(){
      this.commentParam.id = this.$route.query.q
      getPlayComment(this.commentParam)
      .then((value) => {
        // console.log(value);
        this.comments = value.data.comments
        this.hotComments = value.data.hotComments
    ...
    _getPlayDetail() {
      ...
      getPlayDetail(this.id)
        .then((value) => {
          // 保存数据
          this.playlist = value.data.playlist;
    ...
    handleCurrentChange(val) {
      this.pageNum = val;
      this.commentParam.offset = val;
      this._getPlayComment(this.commentParam)
    },
  },
  // filters: {
  //   // 时间格式过滤
