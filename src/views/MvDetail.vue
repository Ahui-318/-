    ...
    <div class="mv-wrap">
      ...
      <div class="info-wrap">
        ...
        <div class="mv-info">
          ...
          <span class="number">播放：{{ mvInfo.playCount | playCounts }} 次</span>
          ...
          >
            <div class="img-wrap">
              ...
              <div class="num-wrap">
                ...
                <div class="num">播放： {{ item.playCount | playCounts }}</div>
              </div>
...
<script>
import { getMvDetail, getMv, getSimiMv, getMvComment } from "@/network/mv.js";
...
export default {
  ...
  methods: {
    ...
    async _getMvComment() {
      ...
      this.config.offset = (this.pageNum - 1) * this.pageSize;
      try {
        const data = await getMvComment(this.config);
        // console.log(data);
    ...
    async _getMv() {
      try {
        const result = await getMv(this.id);
        const resultdata = result.data.data
        
        this.url = resultdata.url? resultdata.url : resultdata.brs[240];
      } catch (error) {}
    },
